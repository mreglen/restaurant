...
from app.schemas.ingredient_schema import IngredientCreate, IngredientRead, IngredientUpdate
...
def get_all_ingredients_endpoint(db: Session = Depends(get_db)):
    """
    Возвращает список всех ингредиентов. Доступно всем авторизованным пользователям.
    """
...
def get_ingredient_endpoint(ingredient_id: int, db: Session = Depends(get_db)):
    """
    Возвращает данные ингредиента по ID. Доступно всем авторизованным пользователям.
    """
