...
from app.schemas.v2.table_assignment_schema import TableAssignmentCreate, TableAssignmentRead
from app.controllers.v2.table_assignment_controller import (
